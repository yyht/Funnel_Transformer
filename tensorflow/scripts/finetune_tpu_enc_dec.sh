...
GS_INIT_CKPT_DIR=${GS_ROOT}/model/english/tiny/bert_small_span_mask_real_attn_net_config_tiny_enc_dec_no_skip_denoise_v1
...
GS_PROC_DATA_DIR=${GS_ROOT}/proc_data/glue/enc_dec/${task}
GS_MODEL_DIR=${GS_ROOT}/proc_data/glue/enc_dec/${task}
