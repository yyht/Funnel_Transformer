...
flags.DEFINE_string("root_model_dir", default="",
                    help="Directory for saving the finetuned model.")
flags.DEFINE_string("root_data_dir", default="",
                    help="Directory for saving the finetuned model.")
...
def task_run(task_name):
  ...
  FLAGS.iterations = opt_config[task_name.lower()]['iterations']
  FLAGS.save_steps = opt_config[task_name.lower()]['save_steps']
  FLAGS.train_batch_size = opt_config[task_name.lower()]['batch_size']
  FLAGS.warmup_steps = opt_config[task_name.lower()]['warmup_steps']
  FLAGS.train_steps = opt_config[task_name.lower()]['train_steps']
  ...
  import os, sys
  FLAGS.model_dir = os.path.join(FLAGS.root_model_dir, task_name.lower())
  FLAGS.data_dir = os.path.join(FLAGS.root_data_dir, dataset_name_mapping[task_name.lower()])
  FLAGS.output_dir = os.path.join(FLAGS.root_model_dir, task_name.lower())
  #### Directories
